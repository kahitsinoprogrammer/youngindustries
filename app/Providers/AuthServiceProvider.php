...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $technicalSupportGate = function ($user) {
            try {
                return app(AssetRequestTechnicalSupportMongoService::class)->isTechnicalSupport((int) $user->id);
            } catch (\Throwable) {
                return false;
            }
        };

        Gate::define('asset-request.asset-specification', $technicalSupportGate);
        Gate::define('asset-request.assets-approved', $technicalSupportGate);
        Gate::define('tech-support.approve-ticket', $technicalSupportGate);
        Gate::define('tech-support.jira-diagnostics', $technicalSupportGate);
        Gate::define('tech-support.resolve-ticket', $technicalSupportGate);
