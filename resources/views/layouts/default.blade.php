            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree" {{ \App\Helpers\Helper::determineLanguageDirection() == 'rtl' ? 'style="margin-right:12px' : '' }}>
                        ...
                        @auth
                            <li class="treeview{{ (request()->is('assetRequest*') ? ' active' : '') }}">
                                <a href="#">
                                    <x-icon type="requestable" class="fa-fw" />
                                    <span>{{ trans('general.asset_request_menu') }}</span>
                                    <x-icon type="angle-left" class="pull-right fa-fw"/>
                                </a>

                                <ul class="treeview-menu">
                                    <li{!! (request()->is('assetRequest') ? ' class="active"' : '') !!}>
                                    ...
                                    <li{!! (request()->is('assetRequest/approve') ? ' class="active"' : '') !!}>
                                        <a href="{{ route('asset-request.approve') }}">
                                            <x-icon type="checkmark" class="fa-fw" />
                                            {{ trans('general.asset_approve') }}
                                        </a>
                                    </li>

                                    <li{!! (request()->is('assetRequest/status') ? ' class="active"' : '') !!}>
                                        <a href="{{ route('asset-request.status') }}">
                                            <x-icon type="history" class="fa-fw" />
                                            {{ trans('general.asset_request_status') }}
                                        </a>
                                    </li>

                                    @can('asset-request.asset-specification')
                                        <li{!! ((request()->is('assetRequest/asset-specification') || request()->is('assetRequest/asset-specification/*') || request()->is('assetRequest/assets-approved')) ? ' class="active"' : '') !!}>
                                            <a href="{{ route('asset-request.asset-specification') }}">
                                                <x-icon type="assets" class="fa-fw" />
                                    ...
                                    @can('view', \App\Models\Asset::class)
                                        <li{!! (request()->is('assetRequest/chatbot') ? ' class="active"' : '') !!}>
                                            <a href="{{ route('asset-request.chatbot') }}">
                                    ...
                                    @can('superuser')
                                        <li{!! (request()->is('assetRequest/assignaApprover') ? ' class="active"' : '') !!}>
                                            <a href="{{ route('asset-request.assign-approver') }}">
                                                <x-icon type="admin" class="fa-fw" />
                                                {{ trans('general.assign_approver') }}
                                            </a>
                                        </li>

                                        <li{!! (request()->is('assetRequest/assignTechnicalSupport') ? ' class="active"' : '') !!}>
                                            <a href="{{ route('asset-request.assign-technical-support') }}">
                                                <x-icon type="admin" class="fa-fw" />
                        ...
                        @auth
                            <li class="treeview{{ (request()->is('tech-support*') ? ' active' : '') }}">
                                <a href="#">
                                    <x-icon type="maintenances" class="fa-fw" />
                                    <span>{{ trans('general.tech_support_menu') }}</span>
                                    <x-icon type="angle-left" class="pull-right fa-fw"/>
                                </a>

                                <ul class="treeview-menu">
                                    <li{!! (request()->is('tech-support/request-ticket') ? ' class="active"' : '') !!}>
                                        <a href="{{ route('tech-support.request-ticket') }}">
                                            <x-icon type="notes" class="fa-fw" />
                                            {{ trans('general.tech_support_request_ticket') }}
                                        </a>
                                    </li>

                                    <li{!! (request()->is('tech-support/ticket-status') ? ' class="active"' : '') !!}>
                                        <a href="{{ route('tech-support.ticket-status') }}">
                                            <x-icon type="reports" class="fa-fw" />
                                            {{ trans('general.tech_support_ticket_status') }}
                                        </a>
                                    </li>

                                    @can('tech-support.approve-ticket')
                                        <li{!! (request()->is('tech-support/approve-ticket') ? ' class="active"' : '') !!}>
                                            <a href="{{ route('tech-support.approve-ticket') }}">
                                                <x-icon type="checkmark" class="fa-fw" />
                                    ...
                                    @can('tech-support.jira-diagnostics')
                                        <li{!! (request()->is('tech-support/jira-diagnostics') ? ' class="active"' : '') !!}>
                                            <a href="{{ route('tech-support.jira-diagnostics') }}">
                                    ...
                                    @can('tech-support.resolve-ticket')
                                        <li{!! (request()->is('tech-support/resolve-ticket') ? ' class="active"' : '') !!}>
                                            <a href="{{ route('tech-support.resolve-ticket') }}">
                                                <x-icon type="checkmark" class="fa-fw" />
