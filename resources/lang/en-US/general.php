...
return [
    ...
    'asset_chatbot'         => 'Asset Chatbot',
    'asset_chatbot_description' => 'Ask broader asset questions with Ollama handling the language understanding while Laravel keeps the database answers grounded.',
    'asset_previous'        => 'Asset (Previously Assigned)',
    'asset_request'         => 'Asset Request',
    'asset_request_menu'    => 'Asset Request',
    'asset_request_status'  => 'Asset Request Status',
    'asset_request_status_description' => 'Track the latest status of submitted asset requests.',
    'asset_specification'   => 'Asset Specification',
    'asset_specification_description' => 'Review all approved asset requests assigned for technical support handling.',
    ...
    'assign_approver_description' => 'Use this page to assign approvers for asset requests.',
    'assign_technical_support' => 'Assign Technical Support',
    'assign_technical_support_description' => 'Use this page to assign technical support users for approved asset requests.',
    'assigned_to'           => 'Assigned to :name',
    'assignee'              => 'Assigned to',
    'assets_approved'       => 'Assets Approved',
    'assets_approved_description' => 'View asset requests that have already been approved.',
    ...
    'submit'				=> 'Submit',
    'target'                => 'Target',
    'tech_support_menu'     => 'Tech Support',
    'tech_support_approve_ticket' => 'Approve Ticket',
    'tech_support_approve_ticket_description' => 'Review submitted ticket requests and approve or reject them before they move forward.',
    'tech_support_jira_diagnostics' => 'Jira Diagnostics',
    'tech_support_jira_diagnostics_description' => 'Check the Jira account, project access, create-issue permission, and available issue types used by the ticket integration.',
    'tech_support_resolve_ticket' => 'Resolve Ticket',
    'tech_support_resolve_ticket_description' => 'Review approved ticket requests, write the resolution, and close them when the work is finished.',
    'tech_support_ticket_status' => 'Ticket Status',
    'tech_support_ticket_status_description' => 'Browse all ticket requests, search across ticket details, and filter by status to track progress more easily.',
    'tech_support_request_ticket' => 'Request Ticket',
    'tech_support_request_ticket_description' => 'Submit a repair or support request using fields that map cleanly into a Jira issue.',
